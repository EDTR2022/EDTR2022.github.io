...
function onBarraBotones() {
    ...
    AltoY = (divisiones - 1) * seccion-35;
    seccion=0.5*seccion;
    let Margen = seccion / 2;
    let DtM=0.05*Lienzo.width;
    ...
    CxyVelocidad = { x: DtM - (Margen + seccion), y: AltoY + seccion / 2 };
    if (vSJPeriodo) {
    ...
    CxyAceleracion = { x: DtM + Margen + seccion, y: AltoY + seccion / 2 };
    if (vSJDesfase) {
