...
const texto = ["Amplitud ", "Periodo ", "Desfase ", "Formas de la onda", "Opciones",
    "Amplitud ", "Periodo ", "Desfase ", "Velocidad Angular", "Aumentar escala", "Disminuir escala", "Gráfica resultante"];
const medidaTxt = [];
for (let i = 0; i < 12; i++) {
    medidaTxt[i] = (pincel.measureText(texto[i]).width + 40);
}
...
var colorEscala1="white",colorEscala2="white";
        ...
        if (contador > 3) {
            switch (contador) {
                ...
                case 70:
                    Amp="";
                    q=10;
                    A=PosX2-40- medidaTxt[q];
                    B=eje2_Y+AmplitudMax+40;
                    break;
                case 71:
                    Amp="";
                    q=9;
                    A=PosX2-10- medidaTxt[q];
                    B=eje2_Y+AmplitudMax+40;
                    break;
                default:
                    q = contador - 7;
