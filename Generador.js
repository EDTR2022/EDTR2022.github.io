    ...
    if (contador < 7) {
        switch (contador) {
            case 0:
                ...
                pMenu2=false;
                if(pSobreXY){
                    if( pdetalles=="pCrestas" || pdetalles=="pElongacion"){
                        continuar=continuar?false:true;

                    }
                    else{
                        if(pdetalles=="pPeriodo"){
                            OpcionesPeriodo=OpcionesPeriodo<4?++OpcionesPeriodo:1;
                            //console.log(OpcionesPeriodo)
                        }
                    }
                }
                break
...
function onMenu2XY(){
    ...
    var PosX2 = Lienzo.width - PosX1;
    var fuente = "bold 16px Serif";
    var AnchoMenu=165,AltoMenu=210;
