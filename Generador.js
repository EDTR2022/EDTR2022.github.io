                    ...
                    if (onArea(Lienzo, evt, CxyMenu2.x, CxyMenu2.y, 3 * over)) {
                        ...
                        if (onArea(Lienzo, evt, 0, 0, 3 * over)) {
                            ...
                            if(pMenuFormas){
                                ...
                                pSobreXY= (pdetalles=="pCrestas" || pdetalles=="pElongacion")?onAreaXY(Lienzo, evt, Lienzo.width/2, eje1_Y,Lienzo.width/2 ,AmplitudMax)?true:false:false;
                                //if(onAreaXY(Lienzo, evt, Lienzo.width/2, eje1_Y,Lienzo.width/2 ,AmplitudMax)){
                                    //pSobreXY=true;
                                    if(pMenu2){
