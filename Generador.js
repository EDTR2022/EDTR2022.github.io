...
var pdetalles="",pSobreXY=false,pMovimiento=false;
var OpcionesPeriodo;
                ...
                if(!(contador < 40)&&(contador<50)){
                    ...
                    switch(contador-40){
                        ...
                        case 5:
                            ...
                            break;
                        //case 8:
                            //pdetalles="pMovimiento";
                            //break;
                                                        
                    }
                }
                else{
                    if(!(contador < 50)&&(contador<53)){
                        switch(contador-50){
                            case 0:
                                PeriodoVal[0]=true;
                                PeriodoVal[1]=false;
            ...
            if (onArea(Lienzo, evt, CxyAceleracion.x, CxyAceleracion.y, seccion / 2)) {
                ...
                if (onArea(Lienzo, evt, CxyMenu.x, CxyMenu.y, 3 * over)) {
                    ...
                    if (onArea(Lienzo, evt, CxyMenu2.x, CxyMenu2.y, 3 * over)) {
                        ...
                        if (onArea(Lienzo, evt, 0, 0, 3 * over)) {
                            contador=0;
                        }
                        else {
                            if(pMenuFormas){
...
function onMenu2XY(){
    //var CxyMenu2={ x: Lienzo.width - 30, y: eje1_Y-AmplitudMax+22 };
    var PosX2 = Lienzo.width - PosX1;
    var fuente = "bold 16px Serif";
...
function graficar() {
        ...
        if(pdetalles!=""){
            switch (pdetalles){
                ...
                case "pPeriodo":
                    ...
                    onRoundRect(pincel,Lienzo.width/2-30,y,12,12,2,"","gray","white");
                    onRoundRect(pincel,Lienzo.width/2-6,y,12,12,2,"","gray","white");
                    onRoundRect(pincel,Lienzo.width/2+18,y,12,12,2,"","gray","white");
                    ...
                    for(let i=0;i<3;i++){
                        if(PeriodoVal[i]){
                            ...
                            switch (i+1){
                                case 1:
                                    onRoundRect(pincel,Lienzo.width/2-30,y,12,12,2,"","black","black");
                                    onPeriodo1();
                                    break;
                                case 2:
                                    onRoundRect(pincel,Lienzo.width/2-6,y,12,12,2,"","black","black");
                                    onPeriodo2();
                                    break;
                                case 3:
                                    onRoundRect(pincel,Lienzo.width/2+18,y,12,12,2,"","black","black");
                                    onPeriodo3();
                                    break;
                            }
                        }
    ...
    if (contador > 0) {
        ...
        let TipX = [CxyDesplazamiento.x, CxyVelocidad.x, CxyAceleracion.x, CxyMenu.x - 100, CxyMenu2.x ];
